...
export const UserIdentitiesList = (props: any) => {
    ...
    const onCreateCancel = () => { setShowCreate(false) };
    const onEditCancel = () => { setEditItem(null) };
    ...
    return (
        ...
        >
            <Datagrid onClick={() => onRowClick}>
                <ReferenceField label="IDM Provider" source="identityTypeId" reference="identityType">
